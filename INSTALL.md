...
```
python tools/run_net.py --cfg configs/Kinetics/C2D_8x8_R50.yaml --opts NUM_GPUS 1 TRAIN.BATCH_SIZE 8 SOLVER.BASE_LR 0.0125 DATA.PATH_TO_DATA_DIR path_to_your_data_folder
```
